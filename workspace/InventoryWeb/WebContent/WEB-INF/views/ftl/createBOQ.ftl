...
<td>
<div class="form-group">
  <input type="text" id="supplyRate" name="supplyRate" />
</div>
</td>
<td>
<div class="form-group">
  <input type="text" id="erectionRate" name="erectionRate" />
</div>
</td>
<td>
<div class="form-group">
  <input type="text" id="supplyAmount" name="supplyAmount" />
</div>
</td>
<td>
<div class="form-group">
  <input type="text" id="erectionAmount" name="erectionAmount" />
</div>
</td>
</tr>                 
                </tbody>
	...
	<div class="col-md-4 ">
	<div class="ph-20 feature-box text-center object-non-visible" data-animation-effect="fadeInDownSmall" data-effect-delay="100">
	<label>Enter BOQ Name :</label>
	<input type="text" name="boqName" value=""/>
	</div>	
	</div>
	<div class="col-md-4 ">
	<div class="ph-20 feature-box text-center object-non-visible" data-animation-effect="fadeInDownSmall" data-effect-delay="100">
	<label></label>
	<br>
		<button type="button" class="btn btn-default" onClick="appendInventory();">Append Inventory</button>
		</div>	
	</div>	
	</div>
	            <br>
...
var standardType = $('#standardType').children("option:selected").val();
var grade = $('#grade').children("option:selected").val();
var schedule = $('#schedule').children("option:selected").val();
var materialSpec = $('#materialSpec').children("option:selected").val();
var ends = $('#ends').children("option:selected").val();
var size = $('#size').children("option:selected").val();
var quantity = $('#quantity').val();
var supplyRate = $('#supplyRate').val();
var erectionRate = $('#erectionRate').val();
var supplyAmount = $('#supplyAmount').val();
var erectionAmount = $('#erectionAmount').val();

console.log(schedule);
	
	var	template = "<tr>" 
	+ "    <td> <input type='hidden' name='standardType' value='"+standardType+"'></input>"+standardType+"</td>"
	+ "    <td>  <input type='hidden' name='grade' value='"+grade+"'></input>"+grade+"</td>"
	+ "    <td> <input type='hidden' name='schedule' value='"+schedule+"'></input>"+schedule+"</td>"
	+ "    <td> <input type='hidden' name='materialSpec' value='"+materialSpec+"'></input>"+materialSpec+"</td>"
	+ "    <td> <input type='hidden' name='ends' value='"+ends+"'></input>"+ends+"</td>"
	+ "    <td> <input type='hidden' name='size' value='"+size+"'></input>"+size+"</td>"
	+ "    <td> <input type='hidden' name='quantity' value='"+quantity+"'></input>"+quantity+"</td>"
	+ "    <td> <input type='hidden' name='supplyRate' value='"+supplyRate+"'></input>"+supplyRate+"</td>"
	+ "	   <td><input type='hidden' name='erectionRate' value='"+erectionRate+"'></input></td>"
	+ "	   <td><input type='hidden' name='supplyAmount' value='"+supplyAmount+"'></input></td>"
	+ "	   <td><input type='hidden' name='erectionAmount' value='"+erectionAmount+"'></input></td>";
