...
public class HeaderFooter  extends PdfPageEventHelper {
	   ...
	   // String header ="E:/socialAngels/Workspace/workspace/InventoryWeb/WebContent/loginPage/img/peco-logo.png";
	  ...
	  /**
	    ...
	    public void onEndPage(PdfWriter writer, Document document) {
	        ...
	        try {
	        	  	...
	        	  	//	Image image2 = Image.getInstance("E:/socialAngels/Workspace/workspace/InventoryWeb/WebContent/loginPage/img/peco_addr.png");
		        		
	            table.setWidths(new int[]{200, 30});
	            table.setLockedWidth(true);
	            table.getDefaultCell().setBorder(Rectangle.SUBJECT);
	            table.addCell(header);//addCell(header);
